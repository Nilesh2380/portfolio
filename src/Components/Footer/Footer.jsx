  ...
  return (
    <footer className="footer">
      <div className="footer-content">
        <h3><span role="img" aria-label="smile"></span> Nilesh Khune</h3>
        <p>
        ...
        <div className="social-links">
          <a href="https://www.linkedin.com/in/nilesh-khune-88360b257/" target="_blank" rel="noreferrer">
            <FontAwesomeIcon icon={faLinkedin} />
          </a>
          <a href="https://github.com/Nilesh2380" target="_blank" rel="noreferrer">
        ...
        <div className="footer-bottom">
          <p>Nilesh Portfolio © 2024 • <a href="/privacy">Privacy</a> • <a href="/terms">Terms</a></p>
